  ...
  <body class="d-flex">
    <div class="mx-auto flex-column w-50">
      <div class="row">
        ...
        <h2 class="text-center fs-5 text-muted">Online IPv4 ping test – ping any IPv4 address or hostname</h2>
...
<?php if (isset($_GET["host"]) && $_GET["host"] != "") { ?>
      <div class="row">
        <h2 class="text-center logo">Ping4 results for <?php echo htmlspecialchars($_GET["host"]); ?></h2>
      </div>
